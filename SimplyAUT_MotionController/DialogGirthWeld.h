...
public:
	CDialogGirthWeld(CMotionControl&, CLaserControl&, CMagControl&, int& nState, NAVIGATION_PID& pid, 
		CArray<double,double>& data, const CString&, CWnd* pParent = nullptr);   // standard constructor
